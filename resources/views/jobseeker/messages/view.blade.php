        ...
        <div id="dashboard">
            <div class="mt-6 sm:mt-0 lg:col-span-3 col-span-4">
                <div id="subs"  class="bg-white p-8 shadow border border-slate-200 border-t-0 shadow rounded-4xl  w-full">
                    <h4 class="text-xl font-thin text-slate-900 mb-6">@if($message->sender === 'recruiter' || $message->jobseeker_id === 0) To @else From @endif {{ $recruiter->recruiter_first_name }} {{ $recruiter->recruiter_last_name }}</h4>
                    ...
                    <p class="mb-6">
                        <a href="{{ route('jobseeker.message.attachment', ['message' => $message]) }}" class="text-cerise-red-500">Download attachment</a>
                    </p>
                    @endif
