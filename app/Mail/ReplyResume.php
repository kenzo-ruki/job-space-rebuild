...
class ReplyResume extends Mailable
{
    ...
    public function __construct(Recruiter $recruiter, User $jobseeker, Resume $resume, $attachment = '')
    {
        ...
        $this->introLines = "<p>Hello {$this->recruiter->recruiter_first_name} {$this->recruiter->recruiter_last_name}</p><p>You have received a new message from {$this->jobseeker->first_name} {$this->recruiter->last_name}. Please log in to your Jobspace account to check the message.</p>";
    ...
    public function envelope(): Envelope
    {
        $envelope = new Envelope(
            subject: "New Message from Job Seeker: {$this->jobseeker->first_name} {$this->recruiter->last_name}",
        );
        return $envelope;
    }
